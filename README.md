...
```
Please change the version "1.0.4" and the filename "noderedrevpinodes-server_1.0.4_all.deb" to the respective [release](https://github.com/erminas/noderedrevpinodes-server/releases) you want to install.
